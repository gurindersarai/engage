...
export default function CameraPermissionsScreen({ navigation }) {
  ...
  useEffect(() => {
    if (cameraPermissionStatus === 'authorized' && microphonePermissionStatus === 'authorized') navigation.replace('Home');
